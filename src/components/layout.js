...
export default function Layout({ children }) {
  return (
    ...
    <div className='z-20 min-w-[375px] flex flex-row border-2 border-sky-400 fixed top-4 left-[50%] -translate-x-[50%] backdrop-blur-sm bg-white/40 shadow-md text-lg rounded-lg overflow-hidden scrollbar-hide'>
