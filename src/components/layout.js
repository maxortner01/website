...
export default function Layout({ children }) {
  return (
    ...
    <div className='z-20 min-w-[375px] lg:min-w-[600px] flex flex-row border-2 border-sky-400 fixed top-4 left-[50%] -translate-x-[50%] backdrop-blur-sm bg-white/40 shadow-md text-lg rounded-lg overflow-hidden scrollbar-hide'>
        <Link className='min-w-[130px] flex-grow' href="/"><NavBarButton text={"Max Ortner"} className={"font-medium text-sky-500 mr-4"} /></Link>
